...
<body onload="setInterval(function(){window.print();},2000); self.print(); self.close();">
	<?php 
		...
		<?php if(strtotime($rs['ws_assess_date']) >= strtotime(date('Y-m-d')) or $rs['ws_assess_date'] ==''){ ?> 
			...
			<table class="table table-bordered">
				<thead>
					...
					<tr>
						<th colspan="3">สิ่งที่ขอให้ดำเนินการ : <br> &nbsp; &nbsp; &nbsp; &nbsp; <?=$rs['ws_request']=="" ? "-" : $rs['ws_request'];?></th>
					</tr>
					<tr>
						<th colspan="3">รายละเอียดงานคงค้าง : <br> &nbsp; &nbsp; &nbsp; &nbsp; <?=$rs['panding_note']=="" ? "-" : $rs['panding_note'];?></th>
					</tr>
					<tr>
						<th colspan="3">เหตุผลที่คืนงาน : <br> &nbsp; &nbsp; &nbsp; &nbsp; <?=$rs['t_reason']=="" ? "-" : $rs['t_reason'];?></th>
					</tr>
					<tr>
						<th colspan="3"><strong>รายละเอียดการปิดงาน : </strong> <br> &nbsp; &nbsp; &nbsp; &nbsp; <?=$rs['ws_jobdescription']=="" ? "-" : $rs['ws_jobdescription'];?></th>
					</tr>
					<tr>
						<th colspan="3">
